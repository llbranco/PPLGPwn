...
# some codes here, in the "installer.sh" or in the "run2.sh" was made by him. 
# 
# 
#
...
pplgpwn_folder="/media/internal/downloads/PPLGPwn2"
...
startup_cmd="cd $pplgpwn_folder && chmod +x ./run2.sh && ./run2.sh"
...
options() {
    local title="<b>PPLGPwn dejavuln 2nd installer</b>"
...
sleep 3
curl -fsSL -o "$pplgpwn_folder/run2.sh" "$var_link/run2.sh"
sleep 3
#####################################
# HEN select - end                  #
#####################################
